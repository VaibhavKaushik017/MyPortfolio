...
const Contact = () => {
    return (
        <>
            <div className='w-[100%] bg-gradient-to-r from-purple-50 py-10'>
                <section className='flex w-[95%] border-[1px] py-20 border-gray-300 container mx-auto'>
                    <div className='flex flex-col lg:flex-row w-[85%] container mx-auto justify-around gap-20'>
                        <div className='lg:w-2/3'>
                            <form className='inline-grid gap-4 w-[100%]' action=''>
                                <p>LEAVE A MESSAGE</p>
                                <input className='border-[1px] py-2 px-4 rounded-sm border-gray-300' placeholder="Your Name" type="text" />
                                <input className="border-[1px] py-2 px-4 rounded-sm border-gray-300" placeholder="E-mail" type="email" />
                                <input className="border-[1px] py-2 px-4 rounded-sm border-gray-300" placeholder="Subject" type="text" />
                                <textarea className="border-[1px] py-2 px-4 rounded-sm border-gray-300" placeholder="Your Message" name="" id="" cols="30" rows="10" />
                                <input type="button" value="Submit" className="bg-[#009DAE] w-[150px] p-2 text-white font-semibold cursor-pointer" />
                            </form>
                        </div>
                        ...
                        <div className='flex flex-col lg:w-1/3 gap-6'>
                            <div>
                                ...
                                <div className='flex gap-2'>
                                    ...
                                    <a className='text-gray-700' href="mailto:kaushikvaibhav017@gmail.com">kaushikvaibhav017@gmail.com</a>
                                </div>
                                <div className='flex gap-2'>
